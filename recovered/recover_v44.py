#!/usr/bin/env python3
"""Route and verify volume 44 publisher PDFs by saved SHA-256 identity."""
...
DEFAULT_CORPUS = ROOT / "corpus-v44"


def load_volume_44_destinations(
...
def main() -> None:
    args = parse_args()
    destinations = load_volume_44_destinations()
    if args.downloads:
