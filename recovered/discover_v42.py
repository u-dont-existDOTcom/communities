...
CONTEXTS = ROOT / "v42-keyword-contexts.txt"
...
METADATA_RECORD_IDS = {
    "M-0022", "M-0023", "M-0024", "M-0033",
    "M-0034", "M-0035", "M-0036", "M-0045",
}


with INVENTORY.open(newline="", encoding="utf-8-sig") as handle:
    source_rows = [row for row in csv.DictReader(handle) if row.get("volume", "") == "42"]
