...
CONTEXTS = ROOT / "v38-keyword-contexts.txt"
...
METADATA_RECORD_IDS = {"M-0936", "M-0937", "M-0938", "M-0947", "M-0948", "M-0949", "M-0955"}


with INVENTORY.open(newline="", encoding="utf-8-sig") as handle:
    source_rows = [row for row in csv.DictReader(handle) if row.get("volume", "") == "38"]
