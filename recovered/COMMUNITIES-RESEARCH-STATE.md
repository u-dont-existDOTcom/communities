...
- *Communal Societies* volumes **1-41** are complete for title and keyword triage.
...
1. Do not repeat volumes 1-41.
2. Retrieve and verify the 24 volume 42 publisher PDFs; 12 are in issue 1 and 12 are in issue 2, together forming the next exact bounded journal unit.
3. Run complete title and keyword discovery, process-family screening, and the separate dangerous-child actor search across all 24 extracted texts.
