...
- *Communal Societies* volumes **1-42** are complete for title and keyword triage.
...
1. Do not repeat volumes 1-42.
2. Retrieve and verify the 37 volume 43 publisher PDFs; 20 are in issue 1 and 17 are in issue 2, together forming the next exact bounded journal unit.
3. Run complete title and keyword discovery, process-family screening, and the separate dangerous-child actor search across all 37 extracted texts.
