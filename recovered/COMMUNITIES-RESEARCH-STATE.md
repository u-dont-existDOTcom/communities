...
- *Communal Societies* volumes **1-36** are complete for title and keyword triage.
...
1. Do not repeat volumes 1-36.
2. Retrieve and verify the 26 volume 37 publisher PDFs; they are the next exact bounded journal unit.
