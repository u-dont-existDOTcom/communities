...
- *Communal Societies* volumes **1-37** are complete for title and keyword triage.
...
1. Do not repeat volumes 1-37.
2. Retrieve and verify the 20 volume 38 publisher PDFs; they are the next exact bounded journal unit.
