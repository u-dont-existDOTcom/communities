...
CONTEXTS = ROOT / "v39-keyword-contexts.txt"
...
METADATA_RECORD_IDS = {
    "M-0956", "M-0957", "M-0958", "M-0966",
    "M-0967", "M-0968", "M-0969", "M-0978",
}


with INVENTORY.open(newline="", encoding="utf-8-sig") as handle:
    source_rows = [row for row in csv.DictReader(handle) if row.get("volume", "") == "39"]
