...
CORPUS = ROOT / "corpus-v29-v30"
RANKING = ROOT / "V29-V30-DISCOVERY-RANKING.csv"
CONTEXTS = ROOT / "v29-v30-keyword-contexts.txt"
CHILD_CONTEXTS = ROOT / "v29-v30-child-danger-contexts.txt"
...
with INVENTORY.open(newline="", encoding="utf-8-sig") as handle:
    source_rows = [
        ...
        if row.get("volume", "").isdigit() and 29 <= int(row["volume"]) <= 30
    ]
