#!/usr/bin/env python3
"""Route and verify volume 41 publisher PDFs by saved SHA-256 identity."""
...
DEFAULT_CORPUS = ROOT / "corpus-v41"


def load_volume_41_destinations(
...
def main() -> None:
    args = parse_args()
    destinations = load_volume_41_destinations()
    if args.downloads:
