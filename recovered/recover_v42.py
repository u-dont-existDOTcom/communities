#!/usr/bin/env python3
"""Route and verify volume 42 publisher PDFs by saved SHA-256 identity."""
...
DEFAULT_CORPUS = ROOT / "corpus-v42"


def load_volume_42_destinations(
...
def main() -> None:
    args = parse_args()
    destinations = load_volume_42_destinations()
    if args.downloads:
