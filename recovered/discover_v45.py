...
CONTEXTS = ROOT / "v45-keyword-contexts.txt"
...
METADATA_RECORD_IDS = {"M-0116", "M-0117", "M-0118", "M-0130"}


with INVENTORY.open(newline="", encoding="utf-8-sig") as handle:
    source_rows = [row for row in csv.DictReader(handle) if row.get("volume", "") == "45"]
