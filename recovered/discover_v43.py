...
CONTEXTS = ROOT / "v43-keyword-contexts.txt"
...
METADATA_RECORD_IDS = {
    "M-0046", "M-0047", "M-0048", "M-0065",
    "M-0066", "M-0067", "M-0081", "M-0082",
}


with INVENTORY.open(newline="", encoding="utf-8-sig") as handle:
    source_rows = [row for row in csv.DictReader(handle) if row.get("volume", "") == "43"]
assert len(source_rows) == 37

ranking_rows: list[dict[str, object]] = []
full_text: dict[str, str] = {}
for row in source_rows:
    path = CORPUS / Path(row["internal_filename"]).relative_to("archive").with_suffix(".txt")
