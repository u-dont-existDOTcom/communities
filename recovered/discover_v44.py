...
CONTEXTS = ROOT / "v44-keyword-contexts.txt"
...
METADATA_RECORD_IDS = {
    "M-0083", "M-0084", "M-0101", "M-0102",
    "M-0103", "M-0104", "M-0105", "M-0115",
}


with INVENTORY.open(newline="", encoding="utf-8-sig") as handle:
    source_rows = [row for row in csv.DictReader(handle) if row.get("volume", "") == "44"]
